	...
	<div class="slider-parallax-inner">
		<div class="swiper-container swiper-parent">
			<div class="swiper-wrapper">
				<div class="swiper-slide dark" style="background-image: url('<?php echo base_url();?>assets/images/ourexpertise/manufacturingbck.png');">
					<div class="container clearfix">
						<div class="slider-caption slider-caption-center">
							<!-- <img data-animate="fadeInUp" data-delay="400" id="fadeimg" src="<?php echo base_url();?>assets/images/ourexpertise/manufacturing.png"> -->
							<!-- <h2 data-animate="fadeInUp" id="banerh2" class="bannerh2">Recruitment Solutions</h2> -->
			...
			<div class="single-post nobottommargin">
				<div class="entry clearfix">
					<div class="heading-block entry-title" data-animate="fadeInUp">
						<!-- <h2 class="mt-5">Recruitment Solutions</h2> -->
					</div>
					
					<div class="entry-content nobottommargin"></div>
					<h3 data-animate="fadeInUp" >Overview</h3>
					<p class="mt-1 mb-1">Eloi’s solutions for Manufacturing Industry help businesses meet their technology requirements right from product engineering to customer experience.  We help industries to reduce operational costs and improve productivity and Overall customer experience.</p>
					<p class="mt-1 mb-1">Our expertise across cloud, IIoT, embedded system and enterprise applications help business built smart manufacturing ecosystem .</p><br>
					<!-- <div id="wheel">
				        <ul>
				    ...
				    <img data-animate="fadeInUp" src="<?php echo base_url();?>assets/images/ourexpertise/manu.png" id="manufactringimage">
					<!-- <div class="entry-image nobottommargin" data-animate="fadeInUp">
						<a href="#"><img src="<?php echo base_url();?>assets/images/ourexpertise/recruitment_content.jpg" alt="Defence & Aerospace" style="border-radius: 25px;height: 400px;" ></a>
					</div> -->
						<!-- <h3>Description:</h3>
						<p>Our expertise across cloud, IIoT, embedded system and enterprise applications help business built smart manufacturing ecosystem.</p> -->
