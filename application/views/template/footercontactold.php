...
<section class="footers bg-light pt-5 pb-3" style="background-color:#002E66 !important">
   <div class="container pt-5">
       <div class="row">
           <div class="col-xs-12 col-sm-6 col-md-4 footers-one">
    		    <div class="footers-logo">
    		        <img src="<?php echo base_url();?>assets/images/eloi_logo.png" alt="Logo" style="max-width:100%;">
    		    </div>
