	...
	<div class="content-wrap">
		<div class="container clearfix">
			<div class="postcontent nobottommargin">
				<img src="<?php echo base_url();?>assets/images/backgrounds/footer/discuss4.png" id="discussimg">
				...
				<div class="form-result"></div>
					<form class="nobottommargin" id="cform" name="cform" action="" method="post">
						...
						<input type="checkbox" name="" value="GDPR" checked>&nbsp;
							I would like to receive relevant updates from Eloi via e-mail and agree to commercial processing of my data.<br><span style="margin: 0 0 0 19px;">(GDPR Opt In)</span><br>
						<input type="checkbox" name="" value="">&nbsp;I accept the Data Protection Policy.*<br>
							<span style="margin: 0 0 0 19px;">You can revoke your privacy consent and stop receiving our updates at any time by notifying us via all known communication channels.</span>
					</form>
				</div>
			</div>
		</div>
       ...
       <div class="row">
    	   ...
    	   <div class="col-xs-12 col-sm-6 col-md-2 footers-two">
    		    ...
    		    <ul class="list-unstyled">
    			 <li><a href="<?php echo base_url('Homectrl/plm_solutions');?>" id="lifootxt">PLM Solutions</a></li>
					<li><a href="<?php echo base_url('Homectrl/erd_solutions');?>" id="lifootxt">ERP Solutions</a></li>
					<li><a href="<?php echo base_url('Homectrl/iot_solutions');?>" id="lifootxt">Bespoke IT Solutions</a></li>
					<li><a href="<?php echo base_url('Homectrl/industrial_manufacturing_solutions');?>" id="lifootxt">Product Engineering</a></li>
					<li><a href="<?php echo base_url('Homectrl/recruitment_solutions');?>" id="lifootxt">ManufacturingAutomation's</a></li>
    			</ul>
    		</div>
    	   <div class="col-xs-12 col-sm-6 col-md-2 footers-three">
    		    <h5 id="footxth5">Industry Focus </h5>
    		    <ul class="list-unstyled">
    			 <li><a href="<?php echo base_url('Homectrl/defence_aerospace');?>" id="lifootxt">Defence & Aerospace</a></li>
					<li><a href="<?php echo base_url('Homectrl/automotives');?>" id="lifootxt">Automotives</a></li>
					<li><a href="<?php echo base_url('Homectrl/healthcare');?>" id="lifootxt">Healthcare</a></li>
					<li><a href="<?php echo base_url('Homectrl/consumer_electronics');?>" id="lifootxt">Consumer Electronics</a></li>
					<li><a href="<?php echo base_url('Homectrl/industrial_products');?>" id="lifootxt">Industrial Products</a></li>
					<li><a href="<?php echo base_url('Homectrl/energy');?>" id="lifootxt">Energy</a></li>
    			</ul>
    		</div>
    	   <div class="col-xs-12 col-sm-6 col-md-2 footers-four">
    		    <h5 id="footxth5">Career</h5>
    		    <p id="lifootxt"><a href="<?php echo base_url('Homectrl/careers');?>" style="color:#fff;">Explore New Opportunity</a></p>
    		    <!-- <ul class="list-unstyled">
...
<script src="<?php echo base_url();?>assets/dist/index.min.js"></script>
...
<script>
	...
	$(document).ready(function(){
		...
		// 		},
		// 		phone:{
		// 			required:"PhoneNo Field is empty",
		// 			number: "Enter valild Contact Number",
		// 			min:"Mobil no allow only 10 numbers",
		// 		},
		// 		subject:{
		...
		//Email send function after form submiting
		$("#submit").on('click' , function(){
			...
			$.ajax({
				type : "POST",
				url : "<?php echo base_url();?>Homectrl/sendmail",
				dataType:"json",
