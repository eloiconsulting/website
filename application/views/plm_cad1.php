	...
	<div class="slider-parallax-inner">
		<div class="swiper-container swiper-parent">
			<div class="swiper-wrapper">
				<div class="swiper-slide dark" style="background-image: url('<?php echo base_url();?>assets/images/insights/case_studies/plm3.jpg');">
		...
		<div class="container clearfix">
			<div id="side-navigation" class="tabs customjs">
				<div class="col_one_third nobottommargin">
					<ul class="sidenav">
						<li><a href="#snav-content1">Business Situation<i class="icon-chevron-right"></i></a></li>
						<li><a href="#snav-content2">Business Benefits<i class="icon-chevron-right"></i></a></li>
						<li><a href="#snav-content3">Eloi Solution/ Contribution & Role<i class="icon-chevron-right"></i></a></li>
						<!-- <li><a href="#snav-content4">Industrial Automation & Manufacturing Service<i class="icon-chevron-right"></i></a></li> -->
						<!-- <li><a href="#snav-content5">Recruitment Service<i class="icon-chevron-right"></i></a></li> -->
					</ul>
				</div>
				<div class="col_two_third col_last nobottommargin">
					<div id="snav-content1">
						...
						<button type="button" class="btn btn-primary" data-toggle="modal" data-target="#exampleModal" data-whatever=""><span>More Info</span><i class="icon-angle-right"></i></button>
					</div>
					...
					<!-- <div id="snav-content4">
						...
						<a href="<?php echo base_url('Homectrl/industrial_service');?>" class="button button-border button-large button-rounded tright nomargin"><span>More Info</span><i class="icon-angle-right"></i></a>
					</div>
